...
- Working Local Directory: /Volumes/Imago/Development/code/Ryder/mhc-control-panel
- Reference Repo Snapshot (zip, if needed): /mnt/data/mhc-control-panel.zip

Critical Instructions (read first…, no hallucinations):

- Confirm the working directory BEFORE any dev work…, ask Master Tracy to confirm: /Volumes/Imago/Development/code/Ryder/mhc-control-panel
